<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Theme Options', 'office_master' ),
        'page_title'           => __( 'Theme Options', 'office_master' ),
...
Redux::setSection($opt_name, array(
    'id' => 'right_coluom_area',
    'title' => 'Right Area',
    'subsection' => true,
    'fields' => array(
        array(
            'id' => 'right_area_icon',
            'title' => 'Right Area Icon',
            'desc' => 'Set here your icon',
            'type' => 'text',
            'default' => 'fa fa-heart'
            ),
         array(
            'id' => 'right_area_title-text',
            'title' => 'Right Area Title',
            'desc' => 'Set here your icon',
            'type' => 'text',  
            ),
           array(
